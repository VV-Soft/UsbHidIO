...
SOURCEFILES_QUOTED_IF_SPACED=C:/microchip/mla/v2016_11_07/bsp/low_pin_count_usb_development_kit/pic16f1459/buttons.c C:/microchip/mla/v2016_11_07/framework/usb/src/usb_device.c ../demo_src/usb_descriptors.c C:/microchip/mla/v2016_11_07/framework/usb/src/usb_device_hid.c ../demo_src/usb_events.c ../demo_src/main.c system.c ../demo_src/app_device_custom_hid.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1254828206/buttons.p1 ${OBJECTDIR}/_ext/1821838623/usb_device.p1 ${OBJECTDIR}/_ext/300881143/usb_descriptors.p1 ${OBJECTDIR}/_ext/1821838623/usb_device_hid.p1 ${OBJECTDIR}/_ext/300881143/usb_events.p1 ${OBJECTDIR}/_ext/300881143/main.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/_ext/300881143/app_device_custom_hid.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1254828206/buttons.p1.d ${OBJECTDIR}/_ext/1821838623/usb_device.p1.d ${OBJECTDIR}/_ext/300881143/usb_descriptors.p1.d ${OBJECTDIR}/_ext/1821838623/usb_device_hid.p1.d ${OBJECTDIR}/_ext/300881143/usb_events.p1.d ${OBJECTDIR}/_ext/300881143/main.p1.d ${OBJECTDIR}/system.p1.d ${OBJECTDIR}/_ext/300881143/app_device_custom_hid.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1254828206/buttons.p1 ${OBJECTDIR}/_ext/1821838623/usb_device.p1 ${OBJECTDIR}/_ext/300881143/usb_descriptors.p1 ${OBJECTDIR}/_ext/1821838623/usb_device_hid.p1 ${OBJECTDIR}/_ext/300881143/usb_events.p1 ${OBJECTDIR}/_ext/300881143/main.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/_ext/300881143/app_device_custom_hid.p1
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/1254828206/buttons.p1: C:/microchip/mla/v2016_11_07/bsp/low_pin_count_usb_development_kit/pic16f1459/buttons.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1254828206" 
	@${RM} ${OBJECTDIR}/_ext/1254828206/buttons.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1254828206/buttons.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N100 -I"../demo_src" -I"C:/microchip/mla/v2016_11_07/framework/usb/inc" -I"C:/microchip/mla/v2016_11_07/bsp/low_pin_count_usb_development_kit/pic16f1459" -I"." --warn=0 --asmlist -DXPRJ_LPCUSBDK_16F1459=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1254828206/buttons.p1  C:/microchip/mla/v2016_11_07/bsp/low_pin_count_usb_development_kit/pic16f1459/buttons.c 
	@-${MV} ${OBJECTDIR}/_ext/1254828206/buttons.d ${OBJECTDIR}/_ext/1254828206/buttons.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1254828206/buttons.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/_ext/300881143/app_device_custom_hid.p1: ../demo_src/app_device_custom_hid.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N100 -I"../demo_src" -I"C:/microchip/mla/v2016_11_07/framework/usb/inc" -I"C:/microchip/mla/v2016_11_07/bsp/low_pin_count_usb_development_kit/pic16f1459" -I"." --warn=0 --asmlist -DXPRJ_LPCUSBDK_16F1459=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/300881143/app_device_custom_hid.p1  ../demo_src/app_device_custom_hid.c 
...
${OBJECTDIR}/_ext/1254828206/buttons.p1: C:/microchip/mla/v2016_11_07/bsp/low_pin_count_usb_development_kit/pic16f1459/buttons.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1254828206/buttons.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1254828206/buttons.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  --double=24 --float=24 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N100 -I"../demo_src" -I"C:/microchip/mla/v2016_11_07/framework/usb/inc" -I"C:/microchip/mla/v2016_11_07/bsp/low_pin_count_usb_development_kit/pic16f1459" -I"." --warn=0 --asmlist -DXPRJ_LPCUSBDK_16F1459=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1254828206/buttons.p1  C:/microchip/mla/v2016_11_07/bsp/low_pin_count_usb_development_kit/pic16f1459/buttons.c 
	@-${MV} ${OBJECTDIR}/_ext/1254828206/buttons.d ${OBJECTDIR}/_ext/1254828206/buttons.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1254828206/buttons.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
